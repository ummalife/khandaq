...
void AboutForm::replaceVersions()
{
    ...
    bodyUI->youAreUsing->setText(tr("You are using Khandaq Messenger version %1.").arg(QString(GIT_DESCRIBE)));
...
#else
    qDebug() << "AboutForm not showing updates, Khandaq built without UPDATE_CHECK";
#endif

    QString commitLink = "https://khandaq.org";
    ...
    bodyUI->clickToReport->setText(
        createLink("https://khandaq.org?body=" + QString::fromUtf8(QUrl(issueBody).toEncoded()),
