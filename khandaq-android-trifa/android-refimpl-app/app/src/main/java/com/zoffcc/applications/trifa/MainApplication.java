...
public class MainApplication extends Application
{
    ...
    private void ensureFcmNotificationChannel()
    {
        ...
        android.net.Uri sound_uri = android.media.RingtoneManager.getDefaultUri(
        ...
        NotificationChannel channel = new NotificationChannel(
                org.khandaq.messenger.KhandaqPush.FCM_WAKE_CHANNEL_ID,
                getString(org.khandaq.messenger.R.string.notification_channel_fcm_wake),
                NotificationManager.IMPORTANCE_HIGH);
        channel.setDescription(getString(org.khandaq.messenger.R.string.notification_channel_fcm_wake_desc));
        channel.setSound(sound_uri, attrs);
    ...
    public static void applyDarkModeFromPref(final String value)
    {
        if (value == null)
        {
            return;
        ...
        switch (value)
        {
            case "0":
                ...
                MainActivity.PREF__dark_mode_pref = 0;
                break;
            case "1":
                AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES);
                MainActivity.PREF__dark_mode_pref = 1;
                break;
            default:
                AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
                MainActivity.PREF__dark_mode_pref = 2;
                break;
        }
    }
}
