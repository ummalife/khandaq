...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        main_profile_avatar = findViewById(R.id.main_profile_avatar);
        ...
        */
        ...
        PREF__DB_secrect_key = DbSecretKeyStorage.loadAutoGeneratedKey(this);
        if (PREF__DB_secrect_key == null)
        {
        ...
        Log.i(TAG, "loaded:native_api=" + native_api);
    ...
    static void launch_incoming_call_activity(boolean videoCall)
    {
        ...
        // main_activity_s stays non-null in onPause — Background Activity Launch blocks startActivityForResult
...
*/
            ...
            if (resultCode == RESULT_OK)
            {
                try
                {
                    ...
                    long new_group_num = tox_group_new(
                            ...
                            HelperGroup.get_group_peer_join_name());
    ...
    static class save_selected_message_custom_asynchtask extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... voids)
        {
            ...
            {
                Log.i(TAG, "save_selected_message_custom_asynchtask:public:EE:" + e.getMessage());
            }
            ...
            {
                Log.i(TAG, "save_selected_message_custom_asynchtask:fallback:EE:" + e.getMessage());
            }
    ...
    static class save_selected_group_message_custom_asynchtask extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... voids)
        {
            ...
            {
                Log.i(TAG, "save_selected_group_message_custom_asynchtask:public:EE:" + e.getMessage());
            }
            ...
            {
                Log.i(TAG, "save_selected_group_message_custom_asynchtask:fallback:EE:" + e.getMessage());
            }
