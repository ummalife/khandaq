...
import static com.zoffcc.applications.trifa.HelperRelay.apply_notification_token_auto;
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            Log.i(TAG, "API:" + Build.VERSION.SDK_INT + " (embedded FCM — no token popup)");
                        }
                    }
                }
                catch (Exception e)
                ...
                try
                {
                    apply_notification_token_auto(tokenReceived);
                }
                catch (Exception e)
                {
                    e.printStackTrace();
