...
namespace {
const QLatin1String globalSettingsFile{"khandaq.ini"};
...
#ifdef Q_OS_WIN
const QLatin1String TCSToxFileFolder{"%APPDATA%/khandaq/"};
#elif defined(Q_OS_OSX)
const QLatin1String TCSToxFileFolder{"~/Library/Application Support/Khandaq"};
#else
const QLatin1String TCSToxFileFolder{"~/.config/khandaq/"};
#endif
...
#if PATHS_VERSION_TCS_COMPLIANT
/**
 * @brief Returns the path to the global settings file "khandaq.ini"
...
// workaround for https://bugreports.qt-project.org/browse/QTBUG-38845
    ...
    return QDir::cleanPath(QStandardPaths::writableLocation(QStandardPaths::HomeLocation)
                           ...
                           + QDir::separator() + "khandaq")
           + QDir::separator();
#elif defined(Q_OS_OSX)
    return QDir::cleanPath(QStandardPaths::writableLocation(QStandardPaths::HomeLocation)
                           + QDir::separator() + "Library" + QDir::separator()
                           + "Application Support" + QDir::separator() + "Khandaq")
           + QDir::separator();
#else
