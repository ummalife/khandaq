...
if(APPLE)
  ...
  install(FILES img/icons/khandaq.icns DESTINATION ${BUNDLE_PATH}/Contents/Resources/)
  ...
  install(FILES "res/org.khandaq.messenger.appdata.xml" DESTINATION "${CMAKE_INSTALL_DATAROOTDIR}/metainfo")
  install(FILES "khandaq.desktop" DESTINATION "${CMAKE_INSTALL_DATAROOTDIR}/applications")

  # Install application icons according to the XDG spec
  set(ICON_SIZES 14 16 22 24 32 36 48 64 72 96 128 192 256 512)
  foreach(size ${ICON_SIZES})
    set(path_from "img/icons/${size}x${size}/khandaq.png")
  ...
  set(SVG_SRC "${CMAKE_SOURCE_DIR}/img/icons/khandaq.svg")
  if(${SVGZ_ICON})
    set(SVG_GZIP "${CMAKE_BINARY_DIR}/khandaq.svgz")
    install(CODE "
