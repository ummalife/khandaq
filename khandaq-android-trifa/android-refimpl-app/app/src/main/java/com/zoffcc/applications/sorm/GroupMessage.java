...
public class GroupMessage
{
    ...
    // + "own reaction state not yet broadcast to the group" flag
    @Column(helpers = Column.Helpers.ALL)
    ...
    public long insert()
    {
        ...
        try
        {
            ...
            insert_pstmt.setString(34, this.reactions);
            insert_pstmt.setBoolean(35, this.reactions_pending);
            // @formatter:on
    ...
    public GroupMessage reactions(String reactions)
    {
        if (this.sql_set.equals(""))
        {
            this.sql_set = " set ";
    ...
    public GroupMessage reactions_pending(boolean reactions_pending)
    {
        if (this.sql_set.equals(""))
        {
            this.sql_set = " set ";
    ...
    public GroupMessage reactions_pendingEq(boolean reactions_pending)
    {
