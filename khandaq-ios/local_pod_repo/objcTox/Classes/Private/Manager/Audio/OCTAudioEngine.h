...
/**
 * Starts the Audio Processing Graph with explicit session options.
 * @param videoCall YES for video calls (VideoChat mode), otherwise VoiceChat.
 * @param reconfigureSession NO when CallKit already activated the session in didActivate.
 */
