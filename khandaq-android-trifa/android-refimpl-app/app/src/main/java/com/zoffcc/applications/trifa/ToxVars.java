...
public class ToxVars
{
    ...
    public static enum TOX_ERR_GROUP_NEW
    {
        TOX_ERR_GROUP_NEW_OK,
        TOX_ERR_GROUP_NEW_NULL,
        TOX_ERR_GROUP_NEW_INIT,
        TOX_ERR_GROUP_NEW_STATE,
        TOX_ERR_GROUP_NEW_NAME_TOO_LONG,
        TOX_ERR_GROUP_NEW_PEER_NAME_TOO_LONG,
        TOX_ERR_GROUP_NEW_TOO_MANY,
    }

    public static enum TOX_ERR_GROUP_INVITE_FRIEND
    {
