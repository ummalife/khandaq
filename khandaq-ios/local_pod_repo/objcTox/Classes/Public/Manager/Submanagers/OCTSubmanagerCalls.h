...
/**
 * When YES, the next startAudioFlow skips AVAudioSession category/activation.
 * Set by CallKit provider in didActivate before answering.
 */
@property (nonatomic, assign) BOOL callKitAudioSessionIsActive;
