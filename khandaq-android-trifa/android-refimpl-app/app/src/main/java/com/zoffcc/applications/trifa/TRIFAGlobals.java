...
public class TRIFAGlobals
{
    ...
    /** Set when user taps a message notification; consumed in MainActivity.onResume. */
    static volatile String pending_notification_chat_key = null;
    ...
    final static String NOTIFICATION_FCM_PUSH_URL_PREFIX = org.khandaq.messenger.KhandaqPush.FCM_PUSH_URL_PREFIX;
    ...
    static final int LEN_TRIFA_MANUAL_PASSWORD_MIN_LEN = 8;
